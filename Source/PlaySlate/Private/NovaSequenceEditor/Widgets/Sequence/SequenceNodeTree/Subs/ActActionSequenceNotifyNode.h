...
public:
	...
	/** TODO: */
	ActActionSequence::ENotifyStateHandleHit DurationHandleHitTest(const FVector2D& CursorTrackPosition) const;
	/** TODO: */
...
protected:
	...
	/** 当前拖拽的状态 */
	ActActionSequence::ENotifyStateHandleHit CurrentDragHandle;
